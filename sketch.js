...
function draw() {
  ...
  textSize(30);
  textAlign(LEFT);
  text("POINTS FOR TODAY?", windowWidth/3, 300);
 

  text("How are you today", windowWidth/3, 420);
  textSize(20);

  text("HAPPY", windowWidth/3, 450);
  text("SAD", windowWidth/3, 510);
  text("ENERGY", windowWidth/3, 570);
